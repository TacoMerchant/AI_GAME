///tmc_ll_demo_backward_circular_chain_test()
show_debug_message("-----------------------")
show_debug_message("tmc_ll_demo_backward_circular_chain_test()")
var item = tmc_ll_item("Ten");
var ten = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Nine"));
var nine = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Eight"));
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Seven"));
var seven = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Six"));
var six = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Five"));
var five = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Four"));
var four = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Tree"));
var item = tmc_ll_item_set_prev(item,tmc_ll_item("Two"));
var two = item;
var item = tmc_ll_item_set_prev(item,tmc_ll_item("One"));
var one = item;

var first = one;
var last = ten;
//link first and last
tmc_ll_item_set_prev(one,ten);

show_debug_message("loop one to ten");
tmc_ll_demo_forward_while_circular(first);
show_debug_message("--------------------");

show_debug_message("loop ten to one");
tmc_ll_demo_backward_while_circular(last);
show_debug_message("--------------------");
...
tmc_ll_demo_forward_for_circular(first);
show_debug_message("--------------------");

show_debug_message("for loop ten to one");
tmc_ll_demo_backward_for_circular(last);
show_debug_message("--------------------");
...
while(tmc_ll_item_get_next_id(first) !=tmc_ll_item_get_id(first))
{
    var item_to_remove = last;
    last = tmc_ll_item_get_prev(last);
    tmc_ll_item_unchain(item_to_remove);
